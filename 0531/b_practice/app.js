...
Object.defineProperty(exports, "__esModule", { value: true });
{
    ...
    var UserManager = /** @class */ (function (_super) {
        ...
        UserManager.prototype.removeUser = function (name) {
    ...
    var userManager_1 = new UserManager();
    function createUser() {
        var name = document.getElementById('name').value;
        var email = document.getElementById('email').value;
        userManager_1.createUser(new User_1(name, email));
    }
    function updateUser() {
        var name = document.getElementById('name').value;
        var email = document.getElementById('email').value;
        userManager_1.updateUser(name, new User_1(name, email));
    }
    function removeUser() {
        var name = document.getElementById('name').value;
        userManager_1.removeUser(name);
    }
}
