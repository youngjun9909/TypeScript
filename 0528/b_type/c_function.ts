// c_function.ts
{
  ...
  const r2 = sum (12, 23, 34, 45, 56);
  console.log(r2);

  const r3 = sum (10, 20, 30, 40, 50);
  console.log(r3);
  ...
  console.log(greetEveryone('박영준',26,'a','b','c','hi'));
  // Hello a, Hello b, Hello c, Hello hi
  ...
  function add(a: any, b: any): any {
    ...
    throw new Error('유효하지 않은 문자입니다.')
  }
  console.log(add(1,2));
  console.log(add('박','영준'));
